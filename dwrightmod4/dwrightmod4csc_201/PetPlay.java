...
public class PetPlay
{
	...
	public static void main (String[] args)
   {
     ...
     System.out.println("There are " +pets.size()+" pets in the collection.");
     System.out.println();
     ...
     for(int i = 0; i<pets.size();i++) {
    	 if (pets.get(i).getName().equalsIgnoreCase("Blackie") && pets.get(i).getType().equals("dog"))
    		 System.out.println("Blackie the dog is " + (i+1) + " in the order");
     }
     for(int i = 0; i<pets.size();i++) {
    	 if (pets.get(i).getName().equalsIgnoreCase("babs") && pets.get(i).getType().equals("bird"))
    		 System.out.println("Babs the bird is " + (i+1) + " in the order");
     }
     for(int i = 0; i<pets.size();i++) {
    	 if (pets.get(i).getName().equalsIgnoreCase("joe") && pets.get(i).getType().equals("turtle"))
    		 System.out.println("Joe the turtle is " + (i+1) + " in the order");
     }
     System.out.println();
     ...
     for(int i = 0; i<pets.size();i++) {
    	 if (pets.get(i).getName().startsWith("A"))
     ...
     for(int i = 0; i<pets.size();i++) {
    	 System.out.println(pets.get(i).getName().toUpperCase());
     }
     System.out.println();
